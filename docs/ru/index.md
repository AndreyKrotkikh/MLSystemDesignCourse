...
- Истоки:
  ...
  - Модель: user‑tariff based; признаки: пользовательские, региональные, конкурентные (временные ряды); каналы доставки цены: приложение/push, SMS, оффлайн; в телекоме вовлечённость в приложение ниже, чем в ритейле.
  - Стейкхолдеры: коммерция/pricing, маркетинг, продукт‑менеджеры тарифов/опций, региональные продажи, сеть/радио/IT, финансы, юристы/регуляторика, CRM/BI/DS, поддержка, абоненты.
  ...
  - Происхождение тарифов: базовые тарифы создаёт маркетинг; под задачи ЦО согласуются персональные/канальные тарифы; для миграций с архивных тарифов также запускаются новые планы.
  ...
  - Текущий процесс: 1–2 раза в год репрайс архивов или миграции; динамика разрешена на опциях; для разовых интернет‑пакетов используется uplift‑моделирование + бандиты; промо часто по правилам.
...
- Важность и причины:
  ...
  - Польза: выше конверсия персональных предложений, меньше blanket‑скидок, таргетированные региональные акции, лучшее покрытие сегментов.
